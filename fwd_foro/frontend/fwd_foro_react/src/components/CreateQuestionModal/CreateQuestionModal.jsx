  ...
  return (
    <div className="create-question-modal create-question-card">
      ...
      <div className="Create-question">
        <button className="open-button btn btn-warning" style={{ display: 'flex' }} onClick={openModal}>
          Crear una pregunta
        </button>
      </div>
      ...
      {showModal && (
        <div className="modal-container">
          <div className="modal-content" style={{ width: '80%',  margin: 'auto', overflow: 'auto' }}>
            {/* Botón de cerrar en la esquina superior derecha */}
            <div className="modal-body">
              <button id="button-de-back" onClick={closeModal}>
                Cerrar
              </button>
              {show ? (
                currUser ? (
