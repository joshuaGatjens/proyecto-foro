...
import './userProfile.css'; // Estilos CSS para personalizar la apariencia
...
const PersonalInfoSection = ({ details, bio, setDetails, setBio, isEditing, setIsEditing }) => {
  ...
  return (
    <div className='bio-details'>
      <div className="personal-info">
        ...
        <Button type="button" value="Editar"
...
const UserProfile = () => {
  // Datos de ejemplo para simular un perfil de usuario
  const [isEditing, setIsEditing] = useState(false);
  const [details, setDetails] = useState('instagram: @Deynna4EverInfinityLove');
  const [bio, setBio] = useState('Estudiante de FWD, cansado de la vida y con ganas de dejar el curso');
  const userData = {
    name: 'Joshua Gatjens Carmona',
    profilePic: '',
  };
